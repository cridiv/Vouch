...
const CodeSection = () => {
  return (
    <section className="w-full py-24 px-8 bg-black overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          className="bg-[#000000] rounded-xl border border-gray-800 shadow-2xl p-6 overflow-hidden"
        >
          ...
          {/* Actual Code */}
          <pre className="font-['JetBrains_Mono'] text-sm md:text-base leading-relaxed overflow-x-auto">
            <code className="text-gray-300">
              <span className="text-purple-400">import</span> {"{ Vouch }"}{" "}
              <span className="text-purple-400">from</span>{" "}
              <span className="text-green-400">'@vouch/sdk'</span>;<br />
              <br />
