...
- **Base URL**: Read from `process.env.VOUCH_API_URL`, defaulting to `http://localhost:5000/v1`
...
|----------|---------|-------------|
| `VOUCH_API_URL` | `http://localhost:5000/v1` | Backend API base URL. Set to your production URL in deployment. |
